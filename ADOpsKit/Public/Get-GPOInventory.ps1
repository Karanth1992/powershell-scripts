...
.DESCRIPTION
    ...
    Outputs a colour-coded HTML report to the OutputPath.
...
.PARAMETER OutputPath
    ...
    Defaults to $env:TEMP\GPOInventory.html
...
.EXAMPLE
    Get-GPOInventory -DomainName "corp.contoso.com" -OutputPath "D:\Reports\GPOInventory.html"
...
#>
    ...
    function Invoke-ADOKGPOCollection {
        param(
            [Parameter(Mandatory = $true)]
            [string]$DomainName
        )
...
"@
    ...
    $inventory = Invoke-ADOKGPOCollection -DomainName $DomainName
