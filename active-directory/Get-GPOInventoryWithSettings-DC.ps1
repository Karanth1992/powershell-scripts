...
.EXAMPLE
    .\Get-GPOInventoryWithSettings-DC.ps1 -DomainName "corp.contoso.com" -OutputPath "D:\Reports\GPOInventoryWithSettings.html"
...
$inventory = Get-GPOInventory -DomainName $DomainName -DomainController $DomainController -SaveXmlFolder $SaveGpoReportXmlFolder
